...
router.get('/answer/:id', requireAuth, answerController.displayCreatePage);  


/* POST Route for processing the create page - CREATE Operation */
router.post('/answer/:id',requireAuth,  answerController.processCreatePage);
    

/* GET Route for displaying the update page - UPDATE Operation */
router.get('/update/:id', r//equireAuth, answerController.displayUpdatePage);
